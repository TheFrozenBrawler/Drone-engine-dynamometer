...
def update(frame):
    ...
    if len(ts) > 0:
        ...
        ax2_twin = ax2.twinx()
        ax2.plot(x, [val / 1000 for val in pc[start_idx:]], label='Current [A]', color='blue', linewidth=2)
        ...
        ax4.plot(x, [val / 1000 for val in tens[start_idx:]], label='Tensometer [kg]', color='brown', linewidth=2)
